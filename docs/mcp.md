...
```text
https://colorado-sar-archive.web.app/api/mcp
```
...
```sh
codex mcp add colorado-sar --url https://colorado-sar-archive.web.app/api/mcp
codex mcp list
```
...
url = "https://colorado-sar-archive.web.app/api/mcp"
```
...
3. Paste `https://colorado-sar-archive.web.app/api/mcp` as the server URL.
...
`https://colorado-sar-archive.web.app/mcp/` for a human-readable page. If a client
